...
namespace Ambulanta
{
    public partial class Form7 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Adresa je obavezan podatak");
                Adresa.Focus();
            }
                else if (BrojTelefona.Text == "")
            {
                MessageBox.Show("BrojTelefona je obavezan podatak");
                BrojTelefona.Focus();
            }
            else if (JMBG.Text == "")
            {
                MessageBox.Show("JMBG je obavezan podatak");
                JMBG.Focus();
            }
            else if (Napomena.Text == "")
            {
                MessageBox.Show("JMBG je obavezan podatak");
                Napomena.Focus();
            }
            ...
            else
            {
                ...
                string sqlupit = "UPDATE Pacijent SET Ime='" + Ime.Text;
                    sqlupit += "', Prezime='" + Prezime.Text + "', Adresa='" + Adresa.Text + "', BrojTelefona='" + BrojTelefona.Text + "',JMBG='"+ JMBG.Text + "',Napomena='" + Napomena.Text ;
                sqlupit += "' WHERE SifPacijenta=" + SifPacijenta.Text;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            /*formiranje SQL upita komandi*/
            string sqlupit = "DELETE FROM Pacijent WHERE SifPacijenta=" + SifPacijenta.Text;
            Komanda.CommandText = sqlupit;
            int responce = Komanda.ExecuteNonQuery();
            Konekcija.Close();
            this.Close();
