    ...
    public partial class Form6 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sqlupit = "INSERT INTO Pacijent (Ime,Prezime,Adresa,BrojTelefona,JMBG,Napomena) ";
                sqlupit += "VALUES('" + Ime.Text + "', '" + Prezime.Text + "', '" + Adresa.Text + "', '" + BrojTelefona.Text + "', '" + JMBG.Text + "', '" + Napomena.Text + "')";
